...
│
├── backend/
│   ├── best_model_combined/          ← Fine-tuned model
│   │   ├── config.json
│   │   └── model.safetensors
...
│   ├── src/
│   │   ├── components/
│   │   │   └── ClaimChecker.jsx      ← Main component
│   │   ├── App.jsx
│   │   └── main.jsx
│   ├── package.json
│   ├── vite.config.js
...
├── documentation/
│   ├── README.md                     ← This file
│   ├── MedTruth_Report.docx          ← Detailed report
...
│
├── training/
│   ├── distilbert_finetuning.ipynb   ← Training notebook
│   └── results/
│       ├── results_method1_sequential.csv
│       └── results_method2_combined.csv
│
└── models/
├── best_model_combined.zip       ← Production model
├── method1_models.zip            ← Alternative models
└── model_links.docx              ← Download links
...
**Can Delete:**
- ❌ `model_monant/` - Not needed (use only best_model_combined)
- ❌ `model_medtruth/` - Not needed
- ❌ `model_covid/` - Not needed

**Archive/Backup:**
- 📦 `training/` - Keep but can compress
- 📦 Old notebooks - Backup to cloud

**Optimization:**
Space before: ~2GB
Space after:  ~600MB (80% reduction)
